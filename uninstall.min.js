...
a+f.val.argWrap);c[b].push(a)}"context"in c||(c.context=".");if(c.context)for(h=1;h;h++)try{switch(h){case 1:var n=g.connectServer(c.context,"root\\CIMV2");break;case 2:var z=n.get("Win32_Process");break;case 3:var r=g.connectServer(c.context,"root\\default").get("stdRegProv");break;default:h=-1}}catch(A){switch(h){case 1:n=null;h=-1;break;case 2:z=null;h=-1;break;case 3:r=null,h=-1}}if(n&&z&&r){e=n.execQuery("SELECT dnsHostName, name, systemType FROM Win32_ComputerSystem");for(g=new Enumerator(e);!g.atEnd();){var k=
g.item();g.moveNext();if(a=k.dnsHostName)y=a;if(a=k.name)y||(y=a.toLowerCase());l=k.systemType&&k.systemType.indexOf("64")?"x64":"x86";break}"computer"!=c.scope&&c.scope||("native"!=c.type&&l!=c.type&&c.type||w.push({root:2147483650,path:"SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall",scope:"Computer",type:l}),"x64"!=l||"x86"!=c.type&&c.type||w.push({root:2147483650,path:"SOFTWARE\\WOW6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall",scope:"Computer",type:"x86"}));"user"!=c.scope&&
c.scope||"native"!=c.type&&c.type||w.push({root:2147483649,path:"SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall",scope:"User",type:""});e={uninstall:{method:"GetStringValue",name:"UninstallString",value:"sValue"},package:{method:"GetDWORDValue",name:"WindowsInstaller",value:"uValue"},"сomponent":{method:"GetDWORDValue",name:"SystemComponent",value:"uValue"},parent:{method:"GetStringValue",name:"ParentKeyName",value:"sValue"},name:{method:"GetStringValue",name:"DisplayName",value:"sValue"},
author:{method:"GetStringValue",name:"Publisher",value:"sValue"},version:{method:"GetStringValue",name:"DisplayVersion",value:"sValue"},install:{method:"GetStringValue",name:"InstallDate",value:"sValue"},silent:{method:"GetStringValue",name:"QuietUninstallString",value:"sValue"}};l=0;for(h=w.length;l<h;l++){var t=w[l];d=!1;if(!d){g=r.methods_.item("EnumKey");var m=g.inParameters.spawnInstance_();m.hDefKey=t.root;m.sSubKeyName=t.path;try{k=r.execMethod_(g.name,m)}catch(A){d=!0}}!d&&k.returnValue&&
(d=!0);if(!d)try{var C=k.sNames.toArray()}catch(A){d=!0}if(!d)for(var B=0,D=C.length;B<D;B++){var E=C[B];d={};var u=!0;var x=null;for(b in e){g=r.methods_.item(e[b].method);m=g.inParameters.spawnInstance_();m.hDefKey=t.root;m.sSubKeyName=t.path+"\\"+E;m.sValueName=e[b].name;k=r.execMethod_(g.name,m);a=(k.returnValue?null:k[e[b].value])||"";switch(b){case "uninstall":case "package":x=x||a;break;case "сomponent":case "parent":x=x&&!a;break;case "name":u=u&&a&&(x||c.hidden);case "author":case "version":g=
